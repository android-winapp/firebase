...
//    public static final String REGISTER_URL = "http://192.168.1.4/FirebasePushNotification/register.php";
    public static final String REGISTER_URL = "http://winapp.com.sg/demo/Firebasepushnotification/register.php";
}
